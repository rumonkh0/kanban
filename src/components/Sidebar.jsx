...
const admin = [
  {
    ...
    to: "/admin/dashboard",
    children: [
      { label: "Private", to: "/admin/dashboard/private" },
      { label: "Advanced", to: "/admin/dashboard/advanced" },
    ],
  },
  {
    label: "Clients",
  ...
  },
  {
    ...
    to: "/admin/finance",
    children: [
      { label: "Paid By", to: "/admin/finance/payments" },
      { label: "Paid To", to: "/admin/finance/team-payments" },
    ],
  },
  {
    label: "Services",
